...
public class MainActivity extends AppCompatActivity {
        ...
        ItemTouchHelper helper = new ItemTouchHelper(
                new ItemTouchHelper.SimpleCallback(0,
                    ...
                    public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder,
                        ...
                        Toast.makeText(MainActivity.this, "Deleting user number " +
                                myPlayer.getId(), Toast.LENGTH_LONG).show();
            ...
            public void onChanged(@Nullable final List<Player> players) {
                if (players != null) {
                    for (int i = 0; i < players.size(); i++) {
                        ...
                        Log.d("Player.emailAddress", players.get(i).getEmailAddress());
                    }
                }
            }
        });
            ...
            public void onChanged(@Nullable final List<PlayerGame> playerGames) {
                if (playerGames != null) {
                    for (int i = 0; i < playerGames.size(); i++) {
                        ...
                        Log.d("PlayerGame.gameId", Integer.toString(playerGames.get(i).getPlayerId()));
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (email != null) {
            Player player = new Player(0, email, name);
